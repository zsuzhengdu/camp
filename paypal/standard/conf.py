...
# Images
# IMAGE = getattr(settings, "PAYPAL_IMAGE", "http://images.paypal.com/images/x-click-but01.gif")
IMAGE = getattr(settings, "PAYPAL_IMAGE", "https://www.paypal.com/en_US/i/bnr/horizontal_solution_PPeCheck.gif")
SUBSCRIPTION_IMAGE = "https://www.paypal.com/en_US/i/bnr/horizontal_solution_PPeCheck.gif"
# SANDBOX_IMAGE = getattr(settings, "PAYPAL_SANDBOX_IMAGE", "https://www.sandbox.paypal.com/en_US/i/btn/btn_buynowCC_LG.gif")
DONATION_IMAGE = getattr(settings, "PAYPAL_DONATION_IMAGE", "https://www.paypal.com/en_US/i/btn/btn_donateCC_LG.gif")

SANDBOX_IMAGE = getattr(settings, "PAYPAL_SANDBOX_IMAGE", "https://www.paypal.com/en_US/i/bnr/horizontal_solution_PPeCheck.gif")
